...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInputEditTextEthanol = findViewById(R.id.inputEditTextEthanolValueId);
        textInputEditTextGas = findViewById(R.id.inputEditTextGasValueId);
    ...
    public void buttonCalculateClick(View view) {
        ...
        if ((ethanolValue / gasValue) < 0.7){
            //Ethanol é melhor para abastecer
